...
<head>
    ...
    <title>Contact Directory Information Form</title>
...
<body>
    ...
    <div class="form-wrapper">
        <div class="form-container">
            <div class="form-title">Insert Contact Directory Information</div>
            <div class="dot-indicator">
                <span class="dot active"></span>
                <span class="dot"></span>
                <span class="dot"></span>
            </div>
            <form id="contactDirectoryForm" action="contact_insert.php" method="POST">
                <div id="step1">
                    ...
                    <div class="form-group">
                        <h6><i class="fas fa-briefcase"></i> Role</h6>
                        <input type="text" class="form-control" name="role" placeholder="Enter role">
                    </div>
                    <div class="form-group">
                        <h6><i class="fas fa-list"></i> Type</h6>
                ...
                <div id="step3" class="hidden">
                    <div class="form-group">
                        <h6><i class="fas fa-user"></i> Contact Name</h6>
                    ...
                    <div class="form-group">
                        <h6><i class="fas fa-phone"></i> Phone Number</h6>
...
<script>
    ...
    function validateStep1() {
        ...
        const organization = document.getElementsByName('organization')[0];
    ...
    function validateStep3() {
        ...
        const contactName = document.getElementsByName('contact_name')[0];
    ...
    document.getElementById('contactDirectoryForm').addEventListener('submit', function(event) {
