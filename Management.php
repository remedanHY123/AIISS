...
<head>
    ...
    <title>Management Bodies Form</title>
...
<body>
    ...
    <div class="form-wrapper">
        <div class="form-container">
            <div class="form-title">Insert Management Bodies Information</div>
            ...
            <form id="managementBodiesForm" action="management_bodies_insert.php" method="POST">
                <!-- Step 1 -->
                <div id="step1">
                    <div class="form-group">
                        <h6><i class="fas fa-building"></i> Body Name</h6>
                        <input type="text" class="form-control" name="body_name" placeholder="Enter body name" required>
                    </div>
                    <div class="form-group">
                        <h6><i class="fas fa-tasks"></i> Responsibilities</h6>
                        <textarea class="form-control" name="responsibilities" placeholder="Enter responsibilities" required></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div id="step2" class="hidden">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="contact_email" placeholder="Enter contact email" required>
                    </div>
                    <div class="form-group">
                        <h6><i class="fas fa-phone"></i> Contact Phone Number</h6>
...
<script>
    ...
    function validateStep(step) {
        ...
        // Special validation for email and phone number in Step 2
        if (step.id === 'step2') {
